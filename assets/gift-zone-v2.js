...
(()=>{
  ...
  function replacePanel(){
    ...
    panel.innerHTML=`<section class="giftZoneCard">
      ...
      <div class="giftCampaignBanner"><strong>本期大奖</strong><b>5000元消费券 × 3</b><span>共 100 个参与名额 · 部分奖项按活动规则发放</span></div>
      ...
      <div class="giftRule"><strong>活动说明：</strong>礼品码不消耗普通盲盒次数；每个账号对同一礼品码仅能参与一次。5000元消费券按本期活动资格规则发放。香烟奖品仅限符合所在地法定年龄及当地法律要求的用户领取。</div>
    </section>`;
    lucky.after(panel);
